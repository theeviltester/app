window.rhfs=window.rhfs||[];rhfs.push('./extensions/wikia/AdEngine/ghost/gw-12.4.4/ext/googleanalytics.js');
/* 
 * 
...
function onElement(element){
	if(wantElement(element) && $CurrentReporter)
...
ghostLoadReporter.prototype= {
	...
	,end: function(){
		...
		if(shouldSample())
			this.report(
		 		this.getBucketValue(this.duration)
				,"loadTime"
				,this.duration
			)
