...
var displayOverlayAd = function(){
		var OverlayAd = {
			...
			getCreative: function() {
				...
				html += ';';
				if (OverlayAd.settings.type == "flash") {
					html += '\
						cursor: pointer;';
				}
				html += '\
						height: '+OverlayAd.settings.height+'px;\
						left: '+OverlayAd.settings.xoffset+'px;\
						position: absolute;\
					...
					#wikia_overlay_ad .clickable {\
						...
						left: 0;\
						position: absolute;\
						width: '+parseInt(OverlayAd.settings.width-25)+'px;\
			...
			init: function() {
				...
				if (OverlayAd.settings.type == "image") {
					...
					// TODO: remove this minified file from here
					...
					var flashvars = { clickTAG: OverlayAd.settings.urlencoded, wmode: "transparent" };
					var params = {scale: "noscale", salign: "t", wmode: "transparent", allowscriptaccess: "always", base: "." };
					var attributes = {};
...
displayOverlayAd(); // assume jQuery is already loaded (AdDriver is handling ads)
