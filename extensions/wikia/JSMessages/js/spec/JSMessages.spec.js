window.rhfs=window.rhfs||[];rhfs.push('./extensions/wikia/JSMessages/js/spec/JSMessages.spec.js');
describe('JSMessages', function () {
	...
	var nirvanaMock = {},
		window = {
			wgMessages: {
				...
				pluralComplex: '{{PLURAL:$1|$1 arbuz|$1 arbuzy|$1 arbuzow}} i' +
				' {{PLURAL:$2|$2 melon|$2 melony|$2 melonow}}',
	...
	it('package with messages is properly loaded and applied', function (done) {
		window.wgUserLanguage = defaultLang;
		...
		msg.get(packageName).then(function () {
