window.rhfs=window.rhfs||[];rhfs.push('./extensions/wikia/MiniEditor/js/Wall/Wall.EditMessageForm.js');
		...
		editMessage: function (e) {
			...
			function initEditor() {
				...
				msg.find('.msg-title').first()
					.html('<textarea class="title">' + msg.find('.msg-title a').html() + '</textarea>');
