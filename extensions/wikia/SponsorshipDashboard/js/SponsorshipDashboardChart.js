window.rhfs=window.rhfs||[];rhfs.push('./extensions/wikia/SponsorshipDashboard/js/SponsorshipDashboardChart.js');
var SponsorshipDashboard = function(){
	...
	this.init = function(params) {
		...
		$('.datepicker').bind('change', self.drawFromPickers);
...
//		document.location.href = imageData;
	...
	this.drawFromPickers = function() {
		self.log('drawFromPickers');
