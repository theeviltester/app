window.rhfs=window.rhfs||[];rhfs.push('./extensions/wikia/WikiaMaps/spec/WikiaMapsPoiCategories.spec.js');
describe('wikia.maps.poiCategories', function () {
	'use strict';

	var poiCategoriesModule = modules['wikia.maps.poiCategories'](jQuery);
